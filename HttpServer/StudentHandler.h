...
public:
	...
	void update_personal_info(std::shared_ptr<HttpConnection> con, int id,
	...
	void get_schedule		 (std::shared_ptr<HttpConnection> con, int id, const std::string semester);
